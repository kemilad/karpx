class Karpx < Formula
  ...
  homepage "https://github.com/your-org/karpx"
  version "0.1.0"
  license "Apache-2.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/your-org/karpx/releases/download/v#{version}/karpx_darwin_arm64.tar.gz"
      sha256 "REPLACE_WITH_SHA256_DARWIN_ARM64"
    else
      url "https://github.com/your-org/karpx/releases/download/v#{version}/karpx_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/your-org/karpx/releases/download/v#{version}/karpx_linux_arm64.tar.gz"
      sha256 "REPLACE_WITH_SHA256_LINUX_ARM64"
    else
      url "https://github.com/your-org/karpx/releases/download/v#{version}/karpx_linux_amd64.tar.gz"
